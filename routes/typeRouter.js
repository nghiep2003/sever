...
const modelType = require("../models/typePr");
...
router.get("/list", async (req, res) => {
  try {
    const result = await modelType.find({});
...
router.delete("/delete/:id", async (req, res) => {
  try {
    const result = await modelType.findByIdAndDelete(req.params.id);
    if (result) {
